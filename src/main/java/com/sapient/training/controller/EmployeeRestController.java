...
public class EmployeeRestController {
	...
	@ApiOperation(value = "Get all employee", response=Employee.class,tags="get-all-emp")
	...
	@ApiOperation(value = "Get employees of given job and salary greater than given value",
			    response=Employee.class,tags="get-emp-job-salary")
	...
	@ApiOperation(value = "Get employee by Id",
			response=Employee.class,tags="get-emp-ById")
